...
echo ===================================================
echo   🛠️  Windows Auto-Start Service Installer (Task Scheduler) 🛠️
...
:: Get absolute path of start_system.bat
set BASE_DIR=%~dp0
...
:: Register task running as SYSTEM on startup with highest privileges
